#############################################################################
# Makefile for building: Projektna
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Dec 22 14:29:14 2016
# Project:  Projektna.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile Projektna.pro
#############################################################################
...
Makefile: Projektna.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile Projektna.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Projektna1.0.0 || $(MKDIR) .tmp/Projektna1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Projektna1.0.0/ && $(COPY_FILE) --parents widget.h .tmp/Projektna1.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp .tmp/Projektna1.0.0/ && $(COPY_FILE) --parents widget.ui .tmp/Projektna1.0.0/ && (cd `dirname .tmp/Projektna1.0.0` && $(TAR) Projektna1.0.0.tar Projektna1.0.0 && $(COMPRESS) Projektna1.0.0.tar) && $(MOVE) `dirname .tmp/Projektna1.0.0`/Projektna1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Projektna1.0.0
